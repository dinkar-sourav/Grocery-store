...
const Cart = () => {
  ...
  const {products, currency, cartItems,removeFCart, getCartCount, updateCart, navigate, getCartAmount , axios , user , setCartItems} = useAppContext();
      ...
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.map((product, index) => (
          ...
          >
              ...
              <div>
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    <p>Qty:</p>
                    <select onChange={(e)=>{updateCart(product._id, Number(e.target.value)); }} className="outline-none" value={cartItems[product._id]}>
            ...
            <button onClick={()=>removeFCart(product._id)} className="cursor-pointer mx-auto">
             <img className="inline-blockw-6 h-6" src={assets.remove_icon} alt="remove" />
            </button>
          </div>
        ))}
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                {address.map((add,index)=>(
                    <p
                    key={index}
                    onClick={() => {setShowAddress(false); setSelectedAddress(add)}}
