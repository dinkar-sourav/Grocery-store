        ...
        <div className="flex flex-col md:flex-row gap-16 mt-4">
          ...
          <div className="text-sm w-full md:w-1/2">
            ...
            <div className="flex items-center mt-10 gap-4 text-base">
              ...
              <button className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primary-dull transition" onClick={()=>{
...
{/* related products */}
        <div className="flex flex-col items-center mt-20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full">
                {relatedProducts.filter((product)=>product.inStock).map((product,index)=>(<Card key={index} product={product} />))}
            </div>
